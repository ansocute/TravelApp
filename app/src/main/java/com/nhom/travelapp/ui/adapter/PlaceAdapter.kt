...
class PlaceAdapter(private var places: List<Place>) :
    ...
    class PlaceViewHolder(val binding: ActivityItemPlaceBinding) : RecyclerView.ViewHolder(binding.root)
    ...
    override fun onBindViewHolder(holder: PlaceViewHolder, position: Int) {
        ...
        holder.binding.apply {
            ...
            // Su dung string resource da khai bao trong strings.xml
            tvRating.text = context.getString(R.string.place_rating, place.rating)

            // Glide load image mượt mà
